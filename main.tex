...
\begin{abstract}
	...
	Some code (especially the \texttt{tcolorboxes}) are copied fron \href{https://github.com/4yn/a-lv-notes}{\underline{\color{blue} 4yn's a-lv-notes repository\footnote{https://github.com/4yn/a-lv-notes}}}.
