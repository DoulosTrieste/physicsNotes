...
\begin{document}
	\section{Kinematics}
		...
		\pdef{Distance}{The distance traversed by an object in some time is the entire distance \textbf{regardless of the direction of motion}. The SI unit of distance is the metre [\si{\meter}].}
		...
		\pdef{Average Velocity}{The average velocity of an object is the change in \textbf{rate of change of displacement} of the object from the origin point. The SI unit of velocity is metre per second [\si{\meter\per\second}].}
		
		\peqn{Average Velocity}{The average velocity of an object can be computed as}{\langle v \rangle = \frac{\Sigma s}{\Sigma t}}
		
		\pdef{Instantaneous Velocity}{The instantaneous velocity of an object is the rate of change of displacement of the object at some specific time\textbf{some specific time}. Mathematically, it is the derivative of the displacement function.}
		...
		\pdef{Acceleration}{Acceleration is the \textbf{rate of change of velocity}.}
		...
		\subsection{Freefall}
		\pdef{Freefall}{An object is in freefall when the only force acting on it is due to \textbf{gravity}.}
