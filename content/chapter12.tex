...
\begin{document}
	...
	\pdef{Wave}{A wave is the transfer of energy without the transfer of matter.}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw [->] (0.5,0) -- (0.5,2) node [pos=0.5, anchor=west] {\(A\)};
			\draw [dotted] (1, -2.5) -- (1, 2.5);
			\draw [dotted] (3, -2.5) -- (3, 2.5);
			\draw [<->] (1, -2.25) -- (3, -2.25) node [pos=0.5, anchor=north] {\(\lambda\)};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw [dotted] (1, -2.5) -- (1, 2.5);
			\draw [dotted] (3, -2.5) -- (3, 2.5);
			\draw [<->] (1, -2.25) -- (3, -2.25) node [pos=0.5, anchor=north] {\(T\)};
		\end{tikzpicture}
	\end{center}
	
	\subsection{Wave Equation}
	\peqn{Wave Equation}{For a wave with frequency \(f\) and wavelength \(\lambda\), the velocity \(v\) it is travelling at is equal to}{v = f\lambda}
\end{document}
