...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}
			\draw (1,5) -- (2,5 )to[battery1,v<=\(\varepsilon\)] (4,5) -- (5,5) --(5,3) to[european resistor, l=\(R_2\), v=\(V_2\)] (3,3) to[european resistor, l=\(R_1\), v=\(V_{\mathrm{out}}\)] (1,3) -- (1,5);
			\draw[-o] (1,3) -- (1,2);
			\draw[-o] (3,3) -- (3,2); 
	...
	\peqn{Voltage Divider}{For a resistor \(R_x\) in a series circuit with total resistance \(R_T\), the voltage across the resistor \(R_x\) is}{V_x = \frac{R_x}{R_T} \times \varepsilon}
