...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw (2,0.75) parabola (3,0.7);
			\draw (2,0.25) parabola (3,0.3);
			\draw[latex-] (2,0.75) parabola (1,0.7);
			\draw[latex-] (2,0.25) parabola (1,0.3);
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[very thick,
				...
				\addplot[dashed] plot (\x,-2.5);
				\addplot[red, name path=A] plot (0.75*\x, {5/(1 + exp(-1.7*\x+1.5))-2.5});
				\addplot[red, name path=B] plot (0.75*\x, {5/(1 + exp(-1.7*\x-1.5))-2.5});
				\addplot[blue] plot (1.25*\x, {5/(1 + exp(-1.7*\x+1.5))-2.5});
				\addplot[blue] plot (1.25*\x, {5/(1 + exp(-1.7*\x-1.5))-2.5});
			\end{axis}
		\end{tikzpicture}
	\end{figure}
