...
\begin{document}
	...
	\subsection{Moment}
		\pdef{Moment}{The moment of a force is the product of the force \(F\) and the perpendicular distance from the pivot to the line of action of the force \(r\) \[M_O = r \times F\] The SI unit of moment is newton metre [\si{\newton \metre}].}
		...
		\begin{center}
			\begin{tikzpicture}
				...
				\draw [line width=0.5mm, -stealth] (4,-2) -- (4,-0.2) node[pos=0.5, anchor=west] {\(F\)};
				\draw [stealth-stealth] (0,-1.8) -- (4,-1.8) node[pos=0.5, anchor=north] {\(r\)};
				\draw (0.3,-1)[line width=0.5mm, -stealth] arc (-90:0:0.5) node[pos=0.5, anchor=north west] {turning motion};
			\end{tikzpicture}
		\end{center}
