...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\shadedraw [left color=red, right color=white] (0,0) rectangle (5,0.5);
			\draw [line width=0.5mm, -latex] (0,-1) -- (5,-1) node [pos=0.5, anchor=north] {flow of heat};
		\end{tikzpicture}
	\end{center}
	
	\subsection{Methods of Heat Transfer}
	\pdef{Conduction}{Conduction is the process whereby particles within a medium transfer heat without the movement of the medium itself.}
