...
\begin{document}
	\section{Physical Quantities, Units and Measurement}
		...
		\pdef{Physical Quantity}{A physical quantity is a quantity consisting of a numerical and a unit.}
		...
		\pdef{Scalar Quantity}{A scalar quantity has a magnitude but no direction.}
		...
		\pdef{Precision}{Precision is how well a set of readings of the same physical quantity agree with each other.}
		
		\pdef{Accuracy}{Accuracy is how close the set of readings are to the true value.}
