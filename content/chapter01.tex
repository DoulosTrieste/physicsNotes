...
\begin{document}
	\section{Physical Quantities, Units and Measurement}
		...
		\peqn{Components}{A two-dimensional vector \(\vec{\mathbf{v}}\) can be broken down into components \(\vec{v_x}\) and \(\vec{v_y}\), with magnitudes of}{\vec{\mathbf{v}}_x = \mathbf{v} \cos \theta, \, \vec{\mathbf{v}}_y = \mathbf{v} \sin \theta}
